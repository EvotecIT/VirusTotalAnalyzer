...
### __AllParameterSets
```powershell
Remove-VirusTotalMonitorItem [-Id] <string> [-ApiKey <string>] [-Client <IVirusTotalClient>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
PS> Remove-VirusTotalMonitorItem -ApiKey $ApiKey -Id 'monitor-item-id'
```
...
### -Id
Identifier of the Monitor item to delete.
