...
# Batch lookup with public-key request spacing, duplicate suppression, caching, and concise output.
$Hashes = @(
    'BFF77EECBB2F7DA25ECBC9D9673E5DC1DB68DCC68FD76D006E836F9AC61C547E'
    '44676ad570f565608ddd6759532c3ae7b1e1a97d'
)
$Verdicts = Get-VirusReport -ApiKey $VTApi -Hash $Hashes -Summary
$Verdicts | Select-Object Id, Verdict, Malicious, Suspicious, Reputation, LastAnalysisDate, Permalink

Get-VirusRelationship -ApiKey $VTApi -DomainName 'evotec.xyz' -Relationship Resolutions
